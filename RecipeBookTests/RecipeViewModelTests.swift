...
class RecipeViewModelTests: XCTestCase {
    ...
    func testAddRecipe() {
        sut.addRecipe(name: "Test Recipe", description: "Test Desc", timeInMinutes: 30, servings: 4, imageData: nil)
        ...
        XCTAssertNotNil(recipe.dateAdded, "Recipe dateAdded should not be nil")
    ...
    func testAddRecipeIngredient() {
        ...
        sut.addRecipe(name: recipeName, description: "Classic Italian pasta dish", timeInMinutes: 25, servings: 2, imageData: nil)
        let recipes: [Recipe] = fetchEntities(entityName: "Recipe", context: mockContext)
        ...
        sut.addRecipeIngredient(recipe: testRecipe, ingredient: testIngredient, quantity: 2.0, unit: "pieces", comments: "Large size")
        ...
        XCTAssertEqual(recipeIngredient.comments, "Large size")
